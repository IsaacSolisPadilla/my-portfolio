<template>
  <section id="contact" class="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-24 px-6">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row gap-20">
      ...
      <div class="flex flex-col justify-center text-center md:text-left md:w-1/2 text-gray-300 space-y-10">
        ...
        <div class="flex justify-center md:justify-start gap-12 mt-6">
          ...
          <a
            ...
            class="group flex flex-col items-center space-y-3 hover:text-indigo-500 transition duration-300"
            aria-label="GitHub"
          >
            <svg
              class="w-16 h-16 fill-current group-hover:scale-125 transition-transform duration-300"
              viewBox="0 0 24 24"
      ...
      >
        ...
        <p v-if="successMessage" class="mt-8 text-green-400 font-bold text-center tracking-wide">
          {{ successMessage }}
        </p>
        <p v-if="errorMessage" class="mt-8 text-red-500 font-bold text-center tracking-wide">
          {{ errorMessage }}
        </p>
      </Form>
    </div>
